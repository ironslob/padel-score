...
import com.padelscore.domain.ServeSelectionPreferenceStoring
import com.padelscore.domain.WristRaiseTipStoring
...
class SharedPreferencesTipStore(
    ...
    companion object {
        ...
        fun create(context: Context) =
            SharedPreferencesTipStore(context.getSharedPreferences("padelscore", Context.MODE_PRIVATE))
    }
}
...
class SharedPreferencesStore(
    ...
    companion object {
        ...
        fun create(context: Context) =
            SharedPreferencesStore(context.getSharedPreferences("padelscore", Context.MODE_PRIVATE))
